...
func NewConfig() *OperationBuilder {
...
func (c *OperationBuilder) SetAuthenticationMethod(authMethod AuthenticationMethod) *OperationBuilder {
	c.AuthMethod = authMethod
	return c
}

// NewOperation generates a new operation from the Config, giving the operation the common ground set by the config
func (c *OperationBuilder) NewOperation(method string) (*Operation, error) {
...
func (c *OperationBuilder) WithEndpoint(u string) *OperationBuilder {
...
func (c *OperationBuilder) Validate() error {
